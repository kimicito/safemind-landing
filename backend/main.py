...
PDF_URLS = {
    ...
    "ru": {
        ...
        "hr": f"{FRONTEND_URL}/pdfs/safemind_free_guide_ru_hr.pdf",
        "teacher": f"{FRONTEND_URL}/pdfs/safemind_free_guide_ru_teacher.pdf",
        "legal": f"{FRONTEND_URL}/pdfs/safemind_free_guide_ru_legal.pdf",
        "finance": f"{FRONTEND_URL}/pdfs/safemind_free_guide_ru_finance.pdf",
